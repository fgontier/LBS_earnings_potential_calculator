package elements.axis {
	...
	public class YAxisBase extends Sprite {
		...
		public function init(json:Object,pHeight:Number): void {}
		
		// called once the sprite has been added to the stage
		// so now it has access to the stage
		protected function _init(json:Object, name:String, style:Object,pHeight:Number): void {
			
			//tr.aces('YAxisBase.init() stage', pHeight);
			...
			this.style.steps = this.get_steps(min, max, pHeight);
