package {
	...
	public class Tooltip extends Sprite {
		...
		private function get_pos( e:has_tooltip, pWidth:Number):flash.geom.Point {

			var pos:Object = e.get_tip_pos();

			var x:Number = (pos.x + this.width + 16) > pWidth ? (pWidth - this.width - 16) : pos.x;
		...
		private function show_tip( e:has_tooltip ,pWidth:Number):void {
			
			// remove the 'hide' tween
			Tweener.removeTweens( this );
			var p:flash.geom.Point = this.get_pos( e,pWidth );
		...
		public function draw( e:has_tooltip,pWidth:Number ):void {
		...
		public function closest( elements:Array,pWidth:Number ):void {
			...
			var p:flash.geom.Point = this.get_pos( elements[0],pWidth );
